...
public final class NavHeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvNavUserEmail;

  @NonNull
  public final TextView tvNavUserName;

  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull ShapeableImageView imageView,
      @NonNull TextView tvNavUserEmail, @NonNull TextView tvNavUserName) {
    this.rootView = rootView;
    this.imageView = imageView;
    this.tvNavUserEmail = tvNavUserEmail;
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvNavUserEmail;
      TextView tvNavUserEmail = ViewBindings.findChildViewById(rootView, id);
      if (tvNavUserEmail == null) {
        break missingId;
      }

      id = R.id.tvNavUserName;
      TextView tvNavUserName = ViewBindings.findChildViewById(rootView, id);
      if (tvNavUserName == null) {
        break missingId;
      }

      return new NavHeaderBinding((LinearLayout) rootView, imageView, tvNavUserEmail,
          tvNavUserName);
    }
