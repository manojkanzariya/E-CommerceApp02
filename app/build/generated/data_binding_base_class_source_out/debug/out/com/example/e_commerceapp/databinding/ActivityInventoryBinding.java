...
public final class ActivityInventoryBinding implements ViewBinding {
  ...
  private ActivityInventoryBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerInventory, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityInventoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityInventoryBinding((LinearLayout) rootView, recyclerInventory, toolbar);
    }
