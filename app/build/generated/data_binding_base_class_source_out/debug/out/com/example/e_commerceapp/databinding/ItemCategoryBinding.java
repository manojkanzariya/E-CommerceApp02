...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull CardView rootView, @NonNull ImageView ivCategoryIcon,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((CardView) rootView, ivCategoryIcon, tvCategoryName);
    }
