...
public final class ItemWishlistProductBinding implements ViewBinding {
  ...
  private ItemWishlistProductBinding(@NonNull CardView rootView, @NonNull MaterialButton btnRemove,
  ...
  public static ItemWishlistProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemWishlistProductBinding((CardView) rootView, btnRemove, ivProductImage,
