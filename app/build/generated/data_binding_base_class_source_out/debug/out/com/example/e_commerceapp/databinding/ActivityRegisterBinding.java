...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvBecomeVendor;
  ...
  private ActivityRegisterBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnRegister,
      ...
      @NonNull TextInputLayout tilPassword, @NonNull TextView tvBecomeVendor,
    ...
    this.tvBecomeVendor = tvBecomeVendor;
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvBecomeVendor;
      TextView tvBecomeVendor = ViewBindings.findChildViewById(rootView, id);
      if (tvBecomeVendor == null) {
        break missingId;
      }
      ...
      return new ActivityRegisterBinding((ScrollView) rootView, btnRegister, etEmail, etName,
          etPassword, progressBar, tilEmail, tilName, tilPassword, tvBecomeVendor, tvLogin);
    }
