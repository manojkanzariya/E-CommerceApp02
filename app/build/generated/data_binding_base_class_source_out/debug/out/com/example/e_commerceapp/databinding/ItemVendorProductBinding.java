...
public final class ItemVendorProductBinding implements ViewBinding {
  ...
  private ItemVendorProductBinding(@NonNull MaterialCardView rootView,
  ...
  @NonNull
  public static ItemVendorProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemVendorProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_vendor_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemVendorProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemVendorProductBinding((MaterialCardView) rootView, ivProductImage,
          tvProductName, tvProductPrice, tvProductStock);
    }
