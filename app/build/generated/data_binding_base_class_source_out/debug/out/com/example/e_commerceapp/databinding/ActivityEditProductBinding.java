...
public final class ActivityEditProductBinding implements ViewBinding {
  ...
  private ActivityEditProductBinding(@NonNull ScrollView rootView, @NonNull Button btnSelectImage,
      @NonNull Button btnUpdateProduct, @NonNull ImageView ivProductImage,
  ...
  public static ActivityEditProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditProductBinding((ScrollView) rootView, btnSelectImage, btnUpdateProduct,
